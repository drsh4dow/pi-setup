...
export function createTpsTracker(dependencies: TpsDependencies) {
	return function tpsTracker(pi: ExtensionAPI): void {
...
export default createTpsTracker({ now: () => performance.now() });
