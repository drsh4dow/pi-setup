...
description: "Turn recurring corrections into lints, checks, or scripts instead of more text. Use when you catch yourself writing the same instruction twice."
