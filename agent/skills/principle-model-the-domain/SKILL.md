...
description: "Encode the domain in a structure instead of scattered conditionals. Use when writing stateful logic or when code branches heavily or repeats a shape assumption across files."
