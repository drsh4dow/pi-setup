...
description: "Redesign as if the new requirement were foundational from day one. Use when integrating a new requirement into an existing design instead of bolting it on."
