...
description: "Make illegal states unrepresentable and parse external data at boundaries. Use when designing types or writing code in any statically-typed language."
