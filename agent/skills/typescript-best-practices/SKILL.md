...
Follow the repository's discriminant, branding, schema, and error conventions.
...
- Keep runtime error handling and checks for mutable invariants where failures can occur. Trust established type guarantees without treating internal code as infallible.
