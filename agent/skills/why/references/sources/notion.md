...
- **Doc vs. reality drift.** A spec may say "we'll do X" but the code actually does Y. Report the divergence with citations to both the spec and the implementation.
...
- Relevant linked pages with citation URLs
