...
Retired. The custom compaction extension and runtime patch have been removed at the user's request. Pi now owns compaction with its built-in defaults. The decision below is historical.
